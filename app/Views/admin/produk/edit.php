...
<head>
    ...
    <title>Edit Produk - PRORENTAL</title>
...
<main class="flex-1 px-4 py-8">
    <div class="flex flex-wrap justify-between items-center gap-4 mb-8">
        <h1 class="text-text-primary text-4xl font-black leading-tight tracking-[-0.033em]">
            Edit <span class="text-primary">Produk</span>
        </h1>
    </div>
        ...
        <form action="/admin/produk/update/<?= $produk['id'] ?>" method="post" enctype="multipart/form-data">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" 
                           name="harga_per_hari" 
                           value="<?= esc($produk['harga_per_hari']) ?>" 
                           class="w-full bg-background-dark border border-text-secondary/30 rounded-lg px-4 py-3 text-text-primary focus:outline-none focus:ring-2 focus:ring-primary placeholder:text-text-secondary"
                           required>
                </div>
                ...
                <div>
                    ...
                    <select name="status" 
                        ...
                        <option value="unactive" <?= $produk['status'] == 'unactive' ? 'selected' : '' ?>>Tidak Aktif</option>
                    </select>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" 
                              rows="3"
                              class="w-full bg-background-dark border border-text-secondary/30 rounded-lg px-4 py-3 text-text-primary focus:outline-none focus:ring-2 focus:ring-primary placeholder:text-text-secondary"><?= esc($produk['deskripsi']) ?></textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="spesifikasi" 
                              rows="3"
                              class="w-full bg-background-dark border border-text-secondary/30 rounded-lg px-4 py-3 text-text-primary focus:outline-none focus:ring-2 focus:ring-primary placeholder:text-text-secondary"><?= esc($produk['spesifikasi']) ?></textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex flex-col md:flex-row gap-6 items-start">
                        <div class="flex-shrink-0">
                            <img src="/uploads/produk/<?= $produk['gambar'] ?>" 
                                 width="120" 
                                 height="120" 
                                 class="rounded-lg object-cover border border-text-secondary/30">
                        </div>
                        <div class="flex-1">
                            <input type="file" 
                                   name="gambar" 
